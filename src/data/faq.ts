...
export const PackagesFaqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      'Egy romániai céget fogunk létrehozni számodra, amire innen "micro"-ként fogunk hivatkozni.'
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      'Jelenleg 2 fő tevékenységben tudunk segíteni:<br />- Cégalapítás<br />- Könyvelés'
  },
  {
    question: 'Hogyan tudok létrehozni egy romániai céget?',
    answer:
      'Pontosan ebben fogunk tudni segíteni Neked. Cégalapítás és könyvelés.<br />Létrehoztunk pár csomagot, ahol mindenki magtalálhatja a Neki megfelelőt.'
  },
  {
...
export const SettingUpCompanyFaqs: Faq[] = [
  {
  ...
  },
  {
    ...
    answer:
      'Nem. Mi, a könyvelők és az ügyvédek is tudnak magyarul. Ha olyan helyzetbe kerülnél, ahol szükség van román nyelvtudásra, abban segíteni fogunk. Nem csak fordításban, de személyesen is.'
  },
  {
    question: 'Szükséges-e román lakhely a cég megalapításához?',
    answer:
      'Igen, természetesen. De ne aggodj, ha jelenleg nem rendelkezel román lakcímmel, akkor ebben is tudunk segíteni.'
  },
  {
...
export const AccountingFaqs: Faq[] = [
  ...
  },
  {
    ...
    answer: 'Igen, természetesen.'
  },
  {
    question: 'Ha már van cégem, akkor is tudtok segíteni?',
    answer:
      'Természetesen arra is van lehetőséged, hogy csak a könyvelési szolgáltatásunkat választod.'
  },
  {
    question: 'Milyen számlázó programot használjak?',
    answer:
      'A Billingot szoktuk ajánlani, de a Számlázz.hu is tökéletes. Egészen addig amíg tudtok biztosítani könyvelői hozzáférést, megfelelő lesz.'
  },
  {
