<template>
  <div class="relative bg-white overflow-hidden">
    <svg
      class="hidden lg:block absolute right-[45%] z-10 inset-y-0 h-full w-80 text-white transform translate-x-1/2"
      fill="currentColor"
      viewBox="0 0 100 100"
          ...
          <div class="sm:text-center lg:text-left">
            ...
            >
              <span class="block xl:inline"
                >Egy megízható fejlesztő csapatot keresel?</span
              >
              {{ ' ' }}
            ...
            >
              Álmodd meg, mi megalkotjuk! Weboldalak tervezése és fejlesztése a
              legújabb technológiákkal, hogy vállalkozásod kiemelkedjen az
              online térben!
            </p>
            <div
