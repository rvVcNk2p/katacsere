<template>
  <div class="relative px-10">
    ...
    <p class="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500">
      ...
      ellentétben az átalányadózással szemben, ahol csak
      <span class="text-red-600 font-bold">8,719,750 Forint</span>.
    </p>
    <p class="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500">
      Ha úgy érzed, hogy szükséged lenne erre az összegre, akkor vedd fel Velünk
      a kapcsolatot, bátran!
    </p>
  </div>
</template>
